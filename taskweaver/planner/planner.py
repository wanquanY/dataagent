...
class Planner(Role):
    ...
    def __init__(
        ...
        self.changchengScence_planner_introduction =self.prompt_data["changchengScence_planner_introduction"]
        ...
        self.instruction = self.instruction_template.format(
            ...
            changchengScence_planner_introduction=self.changchengScence_planner_introduction,#添加场景描述
        )
        self.ask_self_cnt = 0
